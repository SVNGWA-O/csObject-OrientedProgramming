...
public class Examples {
    ...
    public void testHWPercentage(){
        GradeCalculator gradeCalc = new GradeCalculator();
        assertEquals(.85, gradeCalc.hwPercentage(60 * 6, 7), 0.01);
    }

    @Test
    public void testHWPercentageAvoidDivideBy0(){
        GradeCalculator gradeCalc = new GradeCalculator();
        assertEquals(0.0, gradeCalc.hwPercentage(0, 0), 0.01);
    }
