...
public  class BTNode<E> implements IBinTree<E> {
    ...
    //final means the field cannot be reassigned
    /** The int in this data node */
    private final E data;
    /** The left subtree */
    private final IBinTree<E> left;

    /** The right subtree */
    private final IBinTree<E> right;

    private final int size; // can be cached because the tree immutable

    private final int height; // can be cached because the tree is immutable
    /**
     ...
     */
    public BTNode(E data, IBinTree<E> left, IBinTree<E> right) {
        this.data = data;
        this.left = left;
        this.right = right;
