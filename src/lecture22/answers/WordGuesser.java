...
public class WordGuesser {
    ...
    public void guessLetter(String letter) throws NotALetterException, OutOfGuessesException, AlreadyGuessedLetterException{
        if(letter.length() != 1){
    ...
    public boolean guessWord(String word) throws OutOfGuessesException, AccidentallyGuessedALetterException, EmptyGuessException{
        ...
        if(currentWord.equals(word.toCharArray()))
        {
            return true;
        }
        else {
